...
function Home() {
  ...
  return (
            ...
            <div className="flex border border-fuchsia-900 h-full">
              ...
              <div className="chatbody w-3/4 bg-blue-100 relative flex flex-col h-full">
                          ...
                          <div
                            className={`${
                              mg.senderId === selectedUserId
                                ...
                                : "bg-blue-400 text-white me-2"
                            } ms-1 mt-1 mb-2 p-3 rounded-lg shadow-sm relative pe-12`}
                          >
                            {mg.content}
                ...
                <div className={`chatsend flex justify-start gap-5 p-5 bg-white ${selectedUserId ? "block" : "hidden"}`}>
                  <input type="file" name="attFile" className="hidden" ref={attFileRef} onChange={uplaodfile} />
                  <button>
   ...
   <FriendRequest/>
          ...
          {activeTab === 4 && <div>Stats Tab Content</div>}
        </div>
      </div>
    </div>
  </>
